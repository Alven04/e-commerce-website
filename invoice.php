...
try {
  ...
  $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $stmt = $conn->prepare("SELECT * FROM tbl_orders_a186683, tbl_staffs_a186683_pt2,
      tbl_customers_a186683_pt2, tbl_orders_details_a186683 WHERE
      tbl_orders_a186683.fld_staff_num = tbl_staffs_a186683_pt2.fld_staff_num AND
      tbl_orders_a186683.fld_customer_num = tbl_customers_a186683_pt2.fld_customer_num AND
      tbl_orders_a186683.fld_order_num = tbl_orders_details_a186683.fld_order_num AND
      tbl_orders_a186683.fld_order_num = :oid");
  ...
  <tr>
    ...
    <th class="text-right">Total(RM)</th>
      ...
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM tbl_orders_details_a186683,
            tbl_products_a186683_pt2 where 
            tbl_orders_details_a186683.fld_product_num = tbl_products_a186683_pt2.fld_product_num AND
            fld_order_num = :oid");
        $stmt->bindParam(':oid', $oid, PDO::PARAM_STR);
          $oid = $_GET['oid'];
        $stmt->execute();
